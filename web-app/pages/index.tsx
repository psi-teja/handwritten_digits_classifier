...
export default function Home() {
  ...
  const handleSubmitClick = () => {
    if (canvasRef.current) {
      ...
      const imageData = context.getImageData(0, 0, canvas.width, canvas.height, {colorSpace:'srgb'}).data;
    ...
    <div>
      <div className={styles.container}>
        <div className={`${styles.component}`} style={{ flexBasis: '30%' }}>
          <DrawingCanvas canvasRef={canvasRef} handleClearClick={handleClearClick} handleSubmitClick={handleSubmitClick}/>
        </div>
